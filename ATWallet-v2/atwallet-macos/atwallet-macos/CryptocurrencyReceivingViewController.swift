...
class CryptocurrencyReceivingViewController: NSViewController {
    ...
    override func viewWillAppear() {
        self.titleLabel.stringValue = "\("receive".localizedString) \(self.tokenInfo?.symbol ?? self.crytocurrencyType?.symbol ?? "cryptocurrency".localizedString)"
