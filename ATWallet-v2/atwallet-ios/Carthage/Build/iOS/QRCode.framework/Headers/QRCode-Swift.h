...
///
- (nonnull instancetype)initWithRgba:(NSString * _Nonnull)rgba SWIFT_DEPRECATED_OBJC("Swift initializer 'CIColor.init(rgba:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
