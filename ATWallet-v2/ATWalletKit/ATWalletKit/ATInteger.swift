...
public struct ATUInt128 {
    ...
    public var bytes: [UInt8] {
        get {
            var value128 = value.value
            while value128.count < 16 {
                value128.append(0)
            }
            return value128
        }
...
public struct ATUInt256 {
    ...
    public var bytes: [UInt8] {
        get {
            var value256 = value.value
            while value256.count < 32 {
                value256.append(0)
            }
            return value256
        }
    ...
    public var bint: BInt? {
        return BInt(Data(self.value.value.reversed()).toHexString(), radix: 16)
    }
    ...
    public init(bint value: BInt) {
        var bytes = value.serialize().reversed() as [UInt8]
        while bytes.count < 32 {
            bytes.append(0)
        }
        self.value = ATInteger(bytes)
    }
