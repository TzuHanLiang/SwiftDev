...
internal protocol ATConstantsProtocol {
    ...
    static var INFURA_API_KEY: String { get }
...
public class ATConstants: ATConstantsProtocol {
    ...
    static var INFURA_API_KEY: String {
    ...
    static var CRYPTOAPIS_API_KEY_BITCOIN_CASH: String {
        // NOTE: Please apply to CryptoAPIs for abtainning API Key
        return ""
    }
    
    static var CRYPTOAPIS_API_KEY_DOGECOIN: String {
        // NOTE: Please apply to CryptoAPIs for abtainning API Key
        return ""
    }
    
    static var CRYPTOAPIS_API_KEY_DASH: String {
        // NOTE: Please apply to CryptoAPIs for abtainning API Key
        return ""
    }
    
    static var CRYPTOAPIS_API_KEY_ETHEREUM: String {
        // NOTE: Please apply to CryptoAPIs for abtainning API Key
        return ""
    }
    
    static var CRYPTOAPIS_API_KEY_ETHEREUM_CLASSIC: String {
        // NOTE: Please apply to CryptoAPIs for abtainning API Key
        return ""
    }
